...
import pt.up.hs.linguistics.config.KafkaProperties;
...
class LinguisticsKafkaResourceIT {
    ...
    void setup() {
        ...
        LinguisticsKafkaResource kafkaResource = new LinguisticsKafkaResource(kafkaProperties);
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/linguistics-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
